/* ───────────────────── IntroTunnel ─────────────────────
   ...
   Sequence:
     ...
     2. 'reveal'  — tunnel ends on a clean screen; the
                    Jp Builders And Developers lockup fades in
                    and holds.
     3. 'out'     — the whole thing dissolves (fade + scale +
                    blur) into the landing page.
     4. 'gone'    — unmounts and calls onDone().

   Customised for Jp Builders And Developers (blue room, brand phrase).
*/
...
const PHRASE = 'Jp Builders And Developers · '; // tiled on all 4 walls
  ...
  return (
    <div className={"intro-tunnel intro-" + phase + (phase === "out" ? " intro-fade" : "")}>
      ...
      <div className="intro-center">
        <div className="intro-logo"><span>Jp Builders And Developers</span><span>REALTY</span></div>
